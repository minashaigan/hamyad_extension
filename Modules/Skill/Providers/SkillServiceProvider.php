...
class SkillServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'skill'
        );
    }
    ...
    {
        $viewPath = resource_path('views/modules/skill');
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'skill');
    }
    ...
    {
        $langPath = resource_path('lang/modules/skill');
